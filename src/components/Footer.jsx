...
const Footer = () => {
  return (
    <div className='bg-[#101010] flex items-center p-8 lg:p-14 gap-6 flex-col '>
      ...
      <div className='flex gap-8 lg:gap-14 pt-8 items-center'>
