            ...
            <div className="flex flex-wrap -mx-4">
                <div className="w-full px-4 md:w-1/2 ">
                    <div className="sticky top-0 z-50 overflow-hidden ">
                        <div className="relative mb-6 border bg-[#55525222] p-4 rounded-lg lg:mb-10 lg:h-2/4 ">
                ...
                <div className="w-full px-4 md:w-1/2 ">
                    <div className="lg:pl-20">
                        <div className="mb-8 ">
                            ...
                            <h2 className="max-w-lg mt-2 mb-6 text-2xl font-bold dark:text-gray-400 md:text-3xl">
                                {product.title}</h2>
